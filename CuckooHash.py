...
class CuckooHash(object):
    ...
    # choose a number as a limit of how much we should 
    # allow there to be rehashing 
    
    # maybe keep track of how full the arrays are and if they are full - grow it
    ...
    def insert(self,key,data): 
        ...
        elif self.__numKeys > len(self.__hashArray1)*.5:
            self.__growHash()
    ...
    def __insert(self,key,data):
        ...
        # limit the number of times we can attempt to e
        for i in range(50):            
            # attempt to insert
            if not CurArray[CurBucket]: 
                CurArray[CurBucket] = n
                return True
